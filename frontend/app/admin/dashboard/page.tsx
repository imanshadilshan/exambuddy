      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-sm text-gray-600">MCQ Papers</p>
            <p className="text-xs text-blue-600 mt-2">24 active today</p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-1">Rs 124,500</h3>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-1">3,421</h3>
            <p className="text-sm text-gray-600">Tests Attempted</p>
            <p className="text-xs text-green-600 mt-2">+156 today</p>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Manage Students</h4>
            ...
            >
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Courses & Exams</h4>
              <p className="text-sm text-gray-600">Create grade-wise courses and exams</p>
            </Link>
            ...
            >
              ...
              <p className="text-sm text-gray-600">Verify and manage payments</p>
            </Link>
            ...
            >
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Rankings</h4>
              <p className="text-sm text-gray-600">Manage student rankings</p>
            </Link>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 pb-4 border-b border-gray-100">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">Kasun Perera joined from Colombo</p>
              </div>
            ...
            <div className="flex items-center gap-4 pb-4 border-b border-gray-100">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">Rs 500 payment from Nimali Silva</p>
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900">New MCQ paper uploaded</p>
                <p className="text-xs text-gray-500">Combined Mathematics - Paper 05</p>
              </div>
